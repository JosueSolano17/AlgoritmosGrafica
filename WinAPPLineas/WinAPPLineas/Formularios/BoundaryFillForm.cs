...
{
    public partial class BoundaryFillForm : Form
    {
        ...
        private Color fillColor = Color.FromArgb(156, 39, 176); // Púrpura
        private Color boundaryColor = Color.FromArgb(255, 152, 0); // Naranja
        private Color drawColor = Color.FromArgb(255, 152, 0);
        private Color explorationColor = Color.FromArgb(150, 76, 175, 80); // Verde
        private Color backtrackColor = Color.FromArgb(150, 33, 150, 243); // Azul
        ...
        private void InitializeCustomComponents()
        {
            ...
            this.Text = "Boundary Fill - Rectángulo Animado";
            ...
            for (int y = 0; y < gridHeight; y++)
            {
                for (int x = 0; x < gridWidth; x++)
                {
                    ...
                    else if (grid[y, x] == 2) // Rellenado
                    {
                        ...
                        if (chkShowNumbers.Checked)
                        {
                            DrawCellNumber(x, y, "F", Color.White);
                        }
                    }
        ...
        private async void BtnStartFill_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                await CRelleno.BoundaryFillAnimated(
                    canvas,
                    center.X,
                    center.Y,
                    fillColor,
        ...
        {
            if (!chkShowExploration.Checked && status != CRelleno.NeighborStatus.Backtrack)
                return;

            if (!chkShowBacktrack.Checked && status == CRelleno.NeighborStatus.Backtrack)
                return;
            ...
            switch (status)
            {
                case CRelleno.NeighborStatus.Free:
                    arrowColor = Color.FromArgb(76, 175, 80); // Verde
                    break;
                case CRelleno.NeighborStatus.Occupied:
                    arrowColor = Color.FromArgb(244, 67, 54); // Rojo
                    break;
                case CRelleno.NeighborStatus.Enqueued:
                    arrowColor = Color.FromArgb(255, 193, 7); // Amarillo
                    break;
                case CRelleno.NeighborStatus.Backtrack:
                    arrowColor = Color.FromArgb(33, 150, 243); // Azul
                    break;
            }
        ...
        private void DrawCell(int gridX, int gridY, Color color, bool showNumber)
        {
            ...
            if (showNumber)
            {
                DrawCellNumber(gridX, gridY, "F", Color.White);
            }
        ...
        private void BoundaryFillForm_Load(object sender, EventArgs e)
        {
